      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <p class="w3-large"><b><i class="fa fa-asterisk fa-fw w3-margin-right w3-text-teal"></i>Skills</b>
            <a href="add.php"><i class="fa fa-plus fa-fw w3-right w3-large w3-text-teal"></i></a>
          </p>
        ...
        ?>
          ...
          <p><?php echo $row["skill_name"];?>
            <a href="index.php?del=<?php echo $row["id"];?>"><i class="fa fa-remove fa-fw w3-right w3-text-teal"></i></a>
          </p>
